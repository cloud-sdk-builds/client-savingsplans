...
[`@aws-sdk/client-savingsplans`](https://www.npmjs.com/package/@aws-sdk/client-savingsplans/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-savingsplans@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2I7gF0WdPo+CN2L97sdCSQH7dhokjVlw5pt+49HetL1X9Bbl7m7s7NJwmfSNemdu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-savingsplans": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-savingsplans@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-savingsplans@3.991.0/index.min.mjs": "sha384-2I7gF0WdPo+CN2L97sdCSQH7dhokjVlw5pt+49HetL1X9Bbl7m7s7NJwmfSNemdu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-savingsplans/blob/refs/tags/3.991.0/LICENSE
```
